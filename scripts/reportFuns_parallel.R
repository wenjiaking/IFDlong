...
uncoverbed.gen=function(interbedfile,bedfile,outfile) {
  ...
  #unmatched_sampleID=unique(intersect_tab[intersect_tab$CDS_name==".",]$SampleID)
  #allsamples=unique(intersect_tab$SampleID)
  #noneCDSind=mclapply(allsamples,function(s) all(intersect_tab$CDS_name[intersect_tab$SampleID==s]=="."), mc.cores = 6)
